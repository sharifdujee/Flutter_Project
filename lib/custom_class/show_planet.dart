...
class ShowPlanet extends StatelessWidget {
  ...
  final List imageList = [kEarthImage, kMarsImage];
    ...
    return InkWell(
      ...
      child: AnimatedSwitcher(
        ...
        transitionBuilder: (Widget child, Animation<double> animation){
            return RotationTransition(turns: customAnimation.drive(Tween<double> (begin: 0.1, end: -0.5)),
        ...
        child: AnimatedOpacity(opacity: opacity, duration: Duration(microseconds: opacityDuration),
        child: SizedBox(
          height: imageHeight,
          child: Image.asset(
            imageList[ind],
